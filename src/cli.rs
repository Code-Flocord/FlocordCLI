...
use crate::{autorepair, discord, installer, logger, process, registry, repair, selector, selfupdate, status, uninstall, updater, openasar};

pub const SUPPORT_URL: &str = "https://discord.gg/CH45T3PH5r";
...
pub fn headless(action: Action, args: &args::Args) {
    match action {
        Action::Status => {
...
pub fn ensure_closed(client: &DiscordClient, silent: bool) -> Option<bool> {
